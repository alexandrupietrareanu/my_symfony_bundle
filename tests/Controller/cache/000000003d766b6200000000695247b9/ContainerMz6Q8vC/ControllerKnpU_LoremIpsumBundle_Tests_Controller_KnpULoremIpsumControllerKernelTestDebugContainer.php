 ...
 * @final
 */
class ControllerKnpU_LoremIpsumBundle_Tests_Controller_KnpULoremIpsumControllerKernelTestDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/ControllerKnpU_LoremIpsumBundle_Tests_Controller_KnpULoremIpsumControllerKernelTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'ControllerKnpU_LoremIpsumBundle_Tests_Controller_KnpULoremIpsumControllerKernelTestDebugContainer',
            ...
            'router.cache_class_prefix' => 'ControllerKnpU_LoremIpsumBundle_Tests_Controller_KnpULoremIpsumControllerKernelTestDebugContainer',
